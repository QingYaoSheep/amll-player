    ...
    var body: some View {
        Form {
            ...
            Section("render.motion") {
                ...
                LabeledContent("render.gradientWidth", value: String(format: "%.0f pt", preferences.configuration.gradientWidth))
                Slider(value: $preferences.configuration.gradientWidth, in: 0 ... 32, step: 1).accessibilityLabel(Text("render.gradientWidth"))
