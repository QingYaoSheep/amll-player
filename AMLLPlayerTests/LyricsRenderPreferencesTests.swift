...
final class LyricsRenderPreferencesTests: XCTestCase {
    ...
    func testAMLLResponsiveFontPresetsUseViewportFormula() {
        ...
        // Source: max(max(8vh, 4vw), 20px); height dominates this viewport.
        XCTAssertEqual(AMLLLyricSizePreset.huge.pointSize(width: 1024, height: 768), 61.44, accuracy: 0.000_001)
        var configuration = LyricsRenderConfiguration()
